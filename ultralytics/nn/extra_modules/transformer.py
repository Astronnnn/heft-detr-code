...
__all__ = ['TransformerEncoderLayer_PFET']
# ######################################## PFET start ########################################

class TransformerEncoderLayer_PFET(nn.Module):
    ...
    def __init__(self, c1, cm=2048, num_heads=8, dropout=0.0, act=nn.GELU(), normalize_before=False):
        ...
        self.norm1 = LayerNorm(c1, data_format="channels_first")
        self.norm2 = LayerNorm(c1, data_format="channels_first")
